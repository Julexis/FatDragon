...
import timer.TimerEventVieillirJardin;
import Interaction.*;

import item.*;

public class ObjetInteractifJardin extends ObjetInteractif{
	
	TimerEvent timerEvent = new TimerEventVieillirJardin(this);
	private Inventaire inventaireJardin;
	Inventaire inventaireJoueur;
	

	public ObjetInteractifJardin(Inventaire i) throws SlickException
	{
		...
		inventaireJoueur = i;
		listeInteraction.add(new InteractionPlanterGraine(this));
		listeInteraction.add(new InteractionRecolterLegume(this));
	}
